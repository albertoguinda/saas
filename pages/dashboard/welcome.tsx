    ...
    <div className="max-w-2xl mx-auto py-16">
      <Card className="flex flex-col items-center gap-8 p-10 shadow-2xl">
        <div className="flex flex-col items-center gap-2">
          ...
          <h1 className="text-3xl font-bold">¡Bienvenido{session?.user?.name ? `, ${session.user.name}` : ""}!</h1>
          <p className="text-default-500 text-center">
            Ya tienes acceso al plan <span className="font-semibold text-green-600">FREE</span>.<br />
            Puedes crear hasta <b>1 proyecto</b> y acceder a tu panel personal.<br />
            ¿Listo para empezar?
          </p>
        </div>
